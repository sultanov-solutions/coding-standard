...
namespace InbrainCodingStandard\Sniffs\TypeHints;
...
{
	private const NAME = 'InbrainCodingStandard.TypeHints.ReturnTypeHint';
	...
	): void
	{
		...
		if ( $returnTypeHint !== null && $returnTypeHint->getTypeHint() == 'mixed' ){
			$phpcsFile->addError(
				sprintf(
					'%s %s() does not have valid return type',
